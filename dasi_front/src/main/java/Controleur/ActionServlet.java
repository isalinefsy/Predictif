 ...
 */
import Actions.AccepterConsultationAction;
...
import Actions.DemanderPredictionAction;
import Actions.ObtenirClientsEmployeAction;
import Actions.ObtenirHistoriqueConsultationEmployeAction;
import Actions.ObtenirProfilEmployeAction;
import Actions.StatistiqueAction;
import Actions.ValiderConsultationAction;
import Serialisation.AccepterConsultationSerialisation;
...
import Serialisation.DemanderPredictionSerialisation;
import Serialisation.ObtenirClientsEmployeSerialisation;
import Serialisation.ObtenirHistoriqueConsultationEmployeSerialisation;
import Serialisation.ObtenirProfilEmployeSerialisation;
import Serialisation.StatistiqueSerialisation;
import Serialisation.ValiderConsultationSerialisation;
import dao.JpaUtil;
...
//            out.println("</html>");
        switch (todo) {
            ...
            case "obtenirStatistique":{
                new StatistiqueAction().executer(request);
                new StatistiqueSerialisation().appliquer(request, response);
                break;
            }
            ...
            case "obtenirProfilEmploye":{
                new ObtenirProfilEmployeAction().executer(request);
                new ObtenirProfilEmployeSerialisation().appliquer(request, response);
                break;
            }
            case "obtenirHistoriqueConsultationEmploye":{
                new ObtenirHistoriqueConsultationEmployeAction().executer(request);
                new ObtenirHistoriqueConsultationEmployeSerialisation().appliquer(request, response);
                break;
            }
            case "obtenirClientsEmploye":{
                new ObtenirClientsEmployeAction().executer(request);
                new ObtenirClientsEmployeSerialisation().appliquer(request, response);
                break;
            }
            ...
            case "accepterConsultation":{
                new AccepterConsultationAction().executer(request);
                new AccepterConsultationSerialisation().appliquer(request, response);
                break;
            }
            case "demanderPrediction":{
                new DemanderPredictionAction().executer(request);
                new DemanderPredictionSerialisation().appliquer(request, response);
                break;
            }
